define([], function() {
  ...
  var workTerms = [
    ...
    },
    {
      ...
      description: '<p>Wish is a large-scale mobile-centric e-commerce platform that focuses on providing an intuitive and highly personalized shopping experience. I was a member of Wish\'s Product Team, where I contributed to Wish\'s Android, iOS, and web client, as well as their MongoDB and Python based backend. My work on the Product Team includes:</p> <ul><li>Implementing experimental features across Wish\'s mobile and web clients, with results including an increase of over 4% in annual order volume and a doubling of product shares to social media</li><li>Analyzing performance of experimental features using Hive (Hadoop data warehouse) to make recommendations concerning their rollout and segmentation</li><li>Revamping fraud detection algorithms to analyze different criteria for high-value users, preventing thousands of false positive detections per month</li></ul>'
    },
    {
